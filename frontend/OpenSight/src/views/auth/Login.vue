...
function naverSocialLogin() {
  window.location.href = 'https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=***REMOVED***&redirect_uri=http://j10b104.p.ssafy.io/api/login/oauth2/code/naver'
}
</script>
